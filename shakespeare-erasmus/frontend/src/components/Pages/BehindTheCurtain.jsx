...
export default function BehindTheCurtain() {
  ...
  return (
    <div
      className="min-h-screen relative overflow-x-hidden flex flex-col items-center pb-24"
      style={{
        background: "linear-gradient(to bottom, #1c0f1a 0%, #000000 100%)",
        color: "#f4dcec",
      }}
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -top-32 right-[-10%] w-[800px] h-[800px] rounded-full mix-blend-screen"
          style={{
            background:
        ...
        <div
          className="absolute bottom-[-20%] left-[-10%] w-[1000px] h-[1000px] rounded-full mix-blend-screen"
          style={{
            background:
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at center, #ffabf3 1.5px, transparent 1.5px)",
      ...
      <main className="relative z-10 w-full max-w-[1280px] mx-auto px-6 md:px-10 pt-24 md:pt-32 flex flex-col items-center">
        ...
        <header className="text-center mb-16 md:mb-24 flex flex-col items-center">
          <p
            className="font-sans text-xs font-bold tracking-[0.2em] uppercase mb-4"
            style={{ color: "#ffabf3" }}
          >
          ...
          <p
            className="font-sans text-base md:text-lg max-w-4xl mx-auto leading-relaxed"
            style={{ color: "#dcbed4" }}
          >
            ...
            >
              ...
              <div className="sh-team-card-avatar w-28 h-28 rounded-2xl overflow-hidden flex-shrink-0 relative border border-transparent group-hover:border-[#ff00ff]/60 transition-colors duration-300 bg-[#1c0f1a] flex items-center justify-center">
                ...
                {member.avatar ? (
                  ...
                  <span className="material-symbols-outlined text-white/30 text-2xl group-hover:text-[#ffabf3]/60 transition-colors">
                    person
                  </span>
                )}
              </div>
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-serif text-xl font-bold text-white group-hover:text-[#ffabf3] transition-colors duration-300">
                  {member.name}
                </h3>
                <p
                  className="font-sans text-[11px] font-bold uppercase tracking-[0.15em] mt-2 truncate flex items-center gap-2"
                  style={{ color: "#d4af37" }}
                >
                  <img
                    src={member.flag}
                    alt={`${t("teamShowcase.countries." + member.countryKey)} flag`}
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center mb-12">
          <div className="flex items-center w-full gap-4 mb-4">
            ...
            <div className="w-12 h-12 rounded-full border border-[#ffabf3]/30 flex items-center justify-center bg-[#1c0f1a]/80">
              <span className="material-symbols-outlined text-[#ffabf3]">
                school
              </span>
            </div>
        ...
        <div className="w-full max-w-4xl mx-auto mb-10">
          <div
            className="relative group overflow-hidden rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-[0_12px_40px_rgba(255,0,255,0.15)]"
            style={{
              background: "rgba(28, 15, 26, 0.65)",
              backdropFilter: "blur(16px)",
              borderTop: "1px solid rgba(255,171,243,0.35)",
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 text-center">
              ...
              <div className="relative px-4 md:px-8 py-4">
                ...
                <p
                  className="font-sans text-sm md:text-base font-medium mb-1"
                  style={{ color: "#ffabf3" }}
                >
                  {t("teamShowcase.academicGuidance.roles.sorin")}
                </p>

                <p className="font-sans text-xs mt-2 text-white/60">
                  {t("teamShowcase.academicGuidance.universities.craiova")}
                </p>
              </div>

              {/* Prof. Claudiu-Ionuț Popîrlan */}
              <div className="relative px-4 md:px-8 py-4">
                {/* Vertical Divider */}
                ...
                <h3 className="font-serif text-2xl md:text-1.5xl font-bold text-white mb-2">
                  Prof. Claudiu-Ionuț Popîrlan
                </h3>
                ...
                <p
                  ...
                  style={{ color: "#ffabf3" }}
                >
                  {t("teamShowcase.academicGuidance.roles.claudiu")}
                </p>
            ...
            {/* ================= HORIZONTAL DIVIDER ================= */}
            <div className="my-6 md:my-8 h-px w-full bg-gradient-to-r from-transparent via-white/20 to-transparent" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 text-center">
              ...
              <div className="relative px-4 md:px-6 py-4">
                {/* Vertical Divider */}
                <div className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 h-20 w-px bg-gradient-to-b from-transparent via-white/20 to-transparent" />
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-24 max-w-5xl mx-auto">
          {/* INDIA */}
          <div
            className="relative overflow-hidden rounded-2xl p-6 md:p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(255,0,255,0.15)] group"
            style={{
              background: "rgba(28, 15, 26, 0.65)",
              backdropFilter: "blur(16px)",
              borderTop: "1px solid rgba(255,171,243,0.35)",
          ...
          >
            {/* Map Background */}
            <div
              className="absolute inset-0 opacity-[0.10] pointer-events-none group-hover:opacity-[0.18] transition-opacity duration-500"
              style={{
                backgroundImage: 'url("/india%20map.png")',
                backgroundSize: "75%",
            ...
            <div className="relative z-10 flex items-center gap-4 mb-8 pb-4 border-b border-white/10">
              ...
              />
              <h2 className="font-sans text-2xl md:text-3xl font-bold tracking-[0.15em] text-white">
                {t("teamShowcase.academicGuidance.countries.india")}
              </h2>
            </div>

            <div className="relative z-10 flex flex-col gap-6">
              <ProfessorItem
                name="Dr. Vikas Kumar Sabata"
                role={t("teamShowcase.academicGuidance.roles.vikas")}
              />
              <ProfessorItem
                name="Ms. Aparupa Patnaik"
                role={t("teamShowcase.academicGuidance.roles.aparupa")}
              />
              <ProfessorItem
                name="Dr. Samuel Rout"
                role={t("teamShowcase.academicGuidance.roles.samuel")}
              />
              <ProfessorItem
                name="Ms. Melanie Waser"
                role={t("teamShowcase.academicGuidance.roles.melanie")}
              />
              <ProfessorItem
                name="Dr. Kadey Soren"
                role={t("teamShowcase.academicGuidance.roles.kadey")}
              />
              <ProfessorItem
                name="Dr. Prasanna Kumar Samanta"
                role={t("teamShowcase.academicGuidance.roles.prasanna")}
              />

              {/* Art of Giving Component */}
              <a
                href="https://artofgiving.in.net/"
                target="_blank"
              ...
              >
                <div className="w-20 h-20 rounded-full overflow-hidden flex-shrink-0 border-2 border-[#ff00ff]/20 group-hover:border-[#ff00ff]/60 transition-colors bg-white">
                  <img
                    src="/AOG.jpeg"
                    alt="Art of Giving Logo"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="text-center sm:text-left flex-1">
                  <h4 className="font-serif text-lg font-bold text-white group-hover:text-[#ffabf3] transition-colors">
                    {t("teamShowcase.academicGuidance.aogTitle")}
                  </h4>
          ...
          >
            ...
            <div
              className="absolute inset-0 opacity-[0.10] pointer-events-none group-hover:opacity-[0.18] transition-opacity duration-500"
              style={{
                backgroundImage: 'url("/kenya%20map.png")',
                backgroundSize: "75%",
                backgroundRepeat: "no-repeat",
                backgroundPosition: "right center",
              }}
            ...
            <div className="relative z-10 flex items-center gap-4 mb-8 pb-4 border-b border-white/10">
              ...
              />
              <h2 className="font-sans text-2xl md:text-3xl font-bold tracking-[0.15em] text-white">
                {t("teamShowcase.academicGuidance.countries.kenya")}
              </h2>
            </div>

            <div className="relative z-10 flex flex-col gap-6">
              <ProfessorItem
                name="Dr. Maranga Jared"
                role={t("teamShowcase.academicGuidance.roles.maranga")}
              />
              <ProfessorItem
                name="Ms. Virginia"
                role={t("teamShowcase.academicGuidance.roles.virginia")}
              />
            </div>
          </div>
        </div>
      ...
      {selectedDeveloper && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          />
          <div
            className="relative w-full max-w-2xl rounded-2xl p-8 sm:p-10 overflow-hidden animate-slide-up"
            style={{
          ...
          >
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <div className="flex flex-col items-center gap-2 mb-8">
                ...
                <div
                  className="flex items-center gap-2 font-sans text-[11px] font-bold uppercase tracking-[0.15em]"
                  style={{ color: "#d4af37" }}
                >
                  <img
                    src={selectedDeveloper.flag}
                    alt={`${t("teamShowcase.countries." + selectedDeveloper.countryKey)} flag`}
                    className="w-4 h-auto rounded-sm object-cover opacity-80"
                  />
                  <span>
                    {t(
                      "teamShowcase.countries." + selectedDeveloper.countryKey,
                    )}
                  </span>
                </div>
              </div>
              ...
              <div className="relative px-6">
                ...
                <p
                  className="font-serif italic text-lg sm:text-xl leading-relaxed relative z-10 whitespace-pre-wrap"
                  style={{ color: "#dcbed4" }}
                >
                  {t("teamShowcase.thoughts." + selectedDeveloper.memberKey)}
                </p>
                <span
                  className="absolute -bottom-8 -right-2 text-5xl opacity-20 font-serif"
                  style={{ color: "#d4af37" }}
                >
                  &rdquo;
                </span>
